...
public class MailSender implements Runnable {
    ...
    private PLogger logger = new PLogger(MailSender.class);
    ...
    /**
     * Intenta enviar todos los E-Mails encolados. Cuando un E-Mail se env�a con
     * �xito se elimina de la cola y se contin�a enviando m�s E-Mails.
     */
