...
public class BossMail {
    ...
    static {
        ...
        if(wsEndpoint == null || wsNombre == null) {
            PException e = new PException(BossError.ERR_APLICACION, "No se pudo inicializar el subsistema de envío de mails", "No se pudo cargar la configuracion de la BDD", null, new String[] {"Verifique la configuración en la BDD"});
    ...
    public static int enviarMailInmediate (MailRequest eMail, String mailName){
    	...
    	try {
            ...
            if ((Integer)call.invoke(new Object[] { serializedMail }) != 0) {
            	throw (new PRuntimeException("El m�todo enviarMail del Web Service " + wsNombre + " retorn� un error.")); 
            }
     ...
     * @return BossMail.OK Si se pudo encolar el mail para su env�o al Web Service. Sino BossMail.ERROR.
     */
    ...
    /**
     * Env�a un E-Mail sin ning�n observer.
     * @param eMail el eMail a enviar.
     * @return BossMail.OK si se pudo encolar el mail para su env�o al Web Service. Sino BossMail.ERROR.
     */
     ...
     *                          value (String) = La direcci�n de E-Mail
     * 
     * @param valores La Hashtable con los pares tipo de destinatario y direcci�n de E-Mail.
    ...
    /**
     * @param direcciones la lista de direcciones a partir de la cual se generar�
    ...
    public static void main(String[] args) {
        ...
        direcciones.add("aanderson@agea.com.ar");
        List destinatarios = BossMail.crearDestinatarios(direcciones,null,null);
        MailRequest mail = new MailRequest();
        mail.setAplicacion("TEST");
        mail.setAsunto("PRUEBA WS");
        mail.setCuerpo("Cuerpo");
        mail.setDestinatarios(destinatarios);
        mail.setDireccionRespuesta("aanderson@agea.com.ar");
        mail.setOrigen("aanderson@agea.com.ar");
        mail.setUsuario("Alfredo");
        BossMail.enviarMail(mail);
    }
