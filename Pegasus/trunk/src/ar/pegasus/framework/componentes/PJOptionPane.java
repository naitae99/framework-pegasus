 ...
 * error, de advertencia, de informaci�n o de pregunta al usuario.
 * @author oarias
 */
public class PJOptionPane {
	 ...
	 * @param message El texto del mensaje.
	 * @param title El título del mensaje.
	 * @return PJOptionPane.YES_OPTION/PJOptionPane.NO_OPTION/
	 *         PJOptionPane.CANCEL_OPTION/PJOptionPane.OK_OPTION/
	 *         PJOptionPane.CLOSED_OPTION
	 */
