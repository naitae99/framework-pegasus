 ...
 * @author oarias
 */
public class PCalendar extends JPanel implements MouseListener, KeyListener, FocusListener, ItemListener {
	private static final long serialVersionUID = -6556623520560692989L;
	 ...
	 */
	public PCalendar(Date date, Date minDate, Date maxDate) {
		setMinDate(minDate);
		setMaxDate(maxDate);
		construct();
		select(date);
	...
	/**
	 * Pone en <b>negrita</b> el d�a de la fecha pasada por par�metro.
	 * @param date La fecha cuyo d�a se pondr� en negrita.
	 */
    ...
    /** Pone a todos los d�as con la fuente default */
    ...
    /** Pone a todos los d�as con el color default */
    ...
    /**
	 * Cambia de <b>color</b> el d�a de la fecha pasada por par�metro.
	 * @param date La fecha cuyo d�a ser� cambiado de color.
    ...
    /**
     * Cambia de <b>color</b> un conjunto de d�as
     * @param dates La lista de d�as a cambiar el color
     * @param color El nuevo color
     */
    ...
    /**
	 * Pone en <b>negrita</b> los d�as correspondientes a las fechas del array.
	 * @param dates Las fechas cuyos d�as ser�n puestos en negrita.
	 */
	...
	/**
	 * Devuelve el <b>d�a</b> seleccionado en el calendario.
	 * @return Devuelve <b>-1</b> si no hay ning�n d�a seleccionado. 
	 */
	 ...
	 * @return Devuelve <b>-1</b> si no hay ning�n mes seleccionado. 
	 */
	...
	/**
	 * Devuelve el <b>a�o</b> seleccionado en el calendario.
	 * @return Devuelve <b>-1</b> si no hay ning�n a�o seleccionado. 
	 */
	...
	private void update() {
		...
		if(day != -1) {
			...
			if(aux.before(getMinDate()))
				//Estoy en mes a�o desde y day es < que el dia desde
				day = DateUtil.getDia(getMinDate());
			else if(aux.after(getMaxDate()))
				//Estoy en mes a�o hasta y day es > que el dia hasta
    ...
    /** M�todo a sobrescribir si se desea hacer algo cuando cambia la fecha del calendario */
	...
	/**
	 * M�todo llamado en el evento de doble click en un d�a determinado.
	 * El m�todo es vac�o para ser sobreescrito.
	 */
	...
	/**
	 * Selecciona la fecha pasada por par�metro en el calendario.
	...
	static class FocusablePanel extends JPanel {
		private static final long serialVersionUID = 9001099767432663899L;
	...
	/**
	 * Retorna el combobox de a�os del componente calendario.
	 * @return cmbYear
	 */
    ...
    /**
     * Setea el icono del bot�n <b>Back</b>.
     * @param backIcon
     */
    public void setBackIcon(String backIcon) {
        PCalendar.backIcon = backIcon;
    ...
    public void setForwardIcon(String forwardIcon) {
        PCalendar.forwardIcon = forwardIcon;
    ...
    //Construye el bot�n 'Atr�s' de los Meses
    ...
    //Construye el bot�n 'Adelante' de los Meses
