...
public class CopyAndPasteMouseListener extends MouseAdapter {
	...
	JMenuItem copyItem;
	JMenuItem pasteItem;
	static final String IMG_CUT = "ar/pegasus/framework/imagenes/clipboard_cut.png";
	static final String IMG_COPY = "ar/pegasus/framework/imagenes/clipboard_copy.png";
	static final String IMG_PASTE = "ar/pegasus/framework/imagenes/clipboard_paste.png";
		...
		if(evt.isPopupTrigger()) {
			...
			if(textComp.isEditable()) {
				...
				try {
					...
					// Si hay texto en el portapapeles habilita la opci�n 'Pegar'
