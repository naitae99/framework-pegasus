	...
	public static Connection getConnection(String jndiDataSource) {
		...
		try {
			...
			try {
				...
				throw new PRuntimeException("Error obteniendo la conexión en GenericDAO: " + sqle.getMessage(),sqle);
			}
		} catch(NamingException ne) {
			log.error("Error en el método getConnection() de la clase GenericDAO: " + ne.getMessage());
			throw new PRuntimeException("Error en el método getConnection() de la clase GenericDAO: " + ne.getMessage(),ne);
		}
		return cnn;
	}
