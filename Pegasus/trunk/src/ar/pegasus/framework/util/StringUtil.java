...
public class StringUtil {
	...
	/**
	 * Pone en May�sculas la <b>primera letra<b> de la cadena pasada por par�metro.
	 * @param str La cadena de caracteres.
	 * @return La nueva cadena de caracteres con la primera letra en may�sculas.
	 */
	...
	/**
	 * Pone en May�sculas las primeras letras de <b>las palabras</b> de una cadena
	 * separadas por un espacio.
	 * @param str La cadena de caracteres.
	 * @return retval La nueva cadena de caracteres con las primeras letras de cada una
	 *                de sus palabras en may�sculas.
	 */
	 ...
	 * por el separador pasado por par�metro.
	 * @param str La cadena de caracteres.
	...
	/**
	 * Devuelve a partir de un array un String con la concatenaci�n de todos elementos
     ...
     * @param totalLength El tama�o total deseado para el String.
     * @return Un String del tama�o total pedido con el valor original precedido de los zeros necesarios.
     */
     ...
     * @param length La longitud m�xima.
    ...
    /**
     * Reformatea la cadena <code>str</code> a un p�rrafo.
     * @param str
	...
	public static void main (String [] args){
		System.out.println(findSubstringSpanish("Pablo f�resto", "Pablo foresto"));
		System.out.println(findSubstringSpanish("ss", "a"));
		System.out.println(findSubstringSpanish("Vega", "V�ga"));
	...
	/**
	 * Retorna true si la lista de tokens esta contenida integramente en
	 * el textoOriginal.
	 * 
	 * @param listaTokens lista con los tokens a buscar.
	 * @param textoOriginal texto donde deben buscarse los toknes
	 * @return true si todos los tokens estan contenidos en el texto original
	 */
	public static boolean estaContenido(String listaTokens, String textoOriginal) {
		String textoBuscado = textoOriginal.toLowerCase();
		String[] tokens = getTokens(listaTokens, StringUtil.ESPACIO_BLANCO);
		for(int i = 0; i < tokens.length; i++){
			String token = tokens[i];
			if(textoBuscado.indexOf(token) < 0)
				return false;
		}
		return true;
	}
