...
import ar.pegasus.framework.Predeterminable;
import ar.pegasus.framework.componentes.PBotonesTablaLight;

import com.l2fprod.gui.plaf.skin.SkinLookAndFeel;

/**
 * Clase que contiene funciones gr�ficas �tiles.
 * @author AGEA S.A.
 */
public class GuiUtil {
	...
	public static void setEstadoPanel(JComponent panel, boolean estado) {
        ...
        for(int i = 0; i < componentes.length; i++) {
            ...
            if((component instanceof JPanel && !(component instanceof PBotonesTablaLight)) ||
	...
	/**
	 * Devuelve <b>true</b> si el componente que gener� el evento pasado por par�metro
	 * est� habilitado.
	 * @param evt El evento que gener� el componente.
	 * @return
	 */
	 ...
	 * @param item El item a saber si est� contenido en la lista.
	 * @return
	 */
	 ...
	 * @param list La lista de items con los que se llenar� el combobox.
	 * @param disable Flag que determina si se deshabilitar� el combobox antes de llenarlo
	...
	/**
	 * Llena un combobox a partir de una lista de items, y para evitar que se disparen los eventos asociados a los listeners, �stos se 
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void llenarComboWithoutListener(JComboBox c, List l, boolean disable) {
		Object elementoActual;
		int predeterminado = -1;
	 ...
	 * @param cmb El combobox del cual se eliminar�n todos los items.
	 */
	 ...
	 * @param cmb El combobox que podr�a contener el item.
    ...
    /**
     * Devuelve el <b>�ndice</b> en el combobox del objeto obj.
     * @param obj El objeto a buscar.
     * @param cmb El combobox donde buscar.
     * @return El �ndice del objeto en el combobox.
     */
	 ...
	 * Si no es as� lo cambia.
	 * @param tabbedPane El contenedor de los tabs.
	 * @param tab El tab en el que se posicionar�.
	 */
	 ...
	 * @param c El componente due�o del cursor.
	 */
    ...
    /**
     * Crea un tooltip HTML con un texto y un �cono.
     * @param text El texto del tooltip.
     * @param icon El �cono del tooltip.
    ...
    /**
     * Crea un tooltip HTML con un t�tulo y un texto. Opcional una nota adicional.
     * @param title El t�tulo del tooltip.
     * @param text El texto del tooltip.
	...
	/**
	 * Setea el tama�o <code>d</code> a los tama�os m�nimo, m�ximo, y preferido
    ...
    /**
     * Setea el <b>�cono</b> de un frame.
     * @param frame la ventana a la que se le setea el �cono.
     * @param icon el �cono a setear a la ventana.
     */
...
//    	frame.setIconImage(Toolkit.getDefaultToolkit().getImage(icon));
    ...
    /**
     * Aplica el <b>look & feel</b> pasado por par�metro.
    ...
    /**
     * Aplica el <b>tema</b> de SkinLF pasado por par�metro.
    ...
    /**
     * Agrega una m�scara de entrada al textfield pasado por par�metro.
     * @param tf El textfield que contendr� la m�scara de entrada.
	...
	/**
	 * Crea un <b>tray icon</b> para el frame pasado por par�metro.
	 * @param frame El frame.
	 * @param icon El �cono que se mostrar� en el �rea de notificaciones.
	 * @param descr La descripci�n que se mostrar� cuando se pase el puntero del mouse por encima del �cono.
	...
	/**
	 * Devuelve el <b>frame</b> al que pertenece el componente pasado por par�metro.
	...
	/**
	 * Cambia la tipograf�a de todas las ventanas.
	 * @param font La nueva tipograf�a.
	 */
	...
	/**
	 * Devuelve el <b>ButtonGroup</b> de un bot�n de radio.
	 * @param button El bot�n del que se obtiene el grupo.
	 * @return
	 */
	...
	/**
	 * Muestra un <b>tooltip</b> con un texto para el componente pasados por par�metro.
	 * Luego de mostrar el tooltip con el texto pasado por par�metro se restablece el tooltip con
	 * el texto original.
	 * @param c El componente que mostrar� el tooltip.
	 * @param text El texto del tooltip.
	...
	/**
	 * Registra el listener pasado por par�metro a la tecla ESC en el di�logo.
	 * @param dialog
	 * @param listener
	 */
