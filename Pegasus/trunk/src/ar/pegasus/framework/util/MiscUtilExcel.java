...
public class MiscUtilExcel {
	...
	/**
	 * Llama a
	 * {@link #exportarAExcel(PJTable, String, String, String, String, IndicadorProgreso, boolean)},
	 * sin filtros
	 * 
	 * @param tabla
	 * @param titulo
	 ...
	 * @param intercalar
	 */
	public void exportarAExcel(PJTable tabla, String titulo, String subtitulo, String absolutePath, IndicadorProgreso indicador, boolean intercalar) {
	 ...
	 */
	public void exportarAExcel(PJTable tabla, String titulo, String subtitulo, String filtros, String ruta, IndicadorProgreso indicador, boolean intercalar) {
	...
	public void exportarAExcelDos(PJTable tabla, PJTable tabla2, String titulo, String titulo2, String subtitulo, String subtitulo2, String ruta,
	 ...
	 *            se va a guardar el archivo.
	 */
	public void exportarAExcel(List<PJTable> tablas, List<String> titulos, List<String> nombresHojas, List<String> filtros, String ruta,
			IndicadorProgreso indicador, boolean intercalar) {
		HSSFWorkbook libro = new HSSFWorkbook();
		for(int i = 0; i < tablas.size(); i++) {
			PJTable tabla = tablas.get(i);
			if(tabla != null) {
	...
	/**
	 * Retorna la constante que representa la alineaci�n de una celda.
	 * 
	 * @param tabla
	 * @param fila
	 * @param col
	 * @return
	 */
	private short getAlineacionCelda(PJTable tabla, int fila, int col) {
		int alineacionCelda = tabla.getAlignmentCell(fila, col);
		if(alineacionCelda == PJTable.CENTER_ALIGN) {
			return HSSFCellStyle.ALIGN_CENTER;
		} else if(alineacionCelda == PJTable.RIGHT_ALIGN) {
	 ...
	 * @return cellStyle
	 */
	private HSSFCellStyle getCellStyle(HSSFWorkbook libro, ArrayList<FuenteCelda> fuentesCeldas, PJTable tabla, int fila, int col, boolean intercalar) {
	...
	private short getFormatoDato(HSSFWorkbook libro, PJTable tabla, int fila, int col) {
	 ...
	 * atributos de la tipograf�a recibidos como par�metro. Si existe alguna que
	 * coincide, retorna la instancia de HSSFFont que esta contiene. Caso
	 * contrario, agrega una nueva instancia de FuenteCelda a la colecci�n.
	 * 
	 * @param libro
	 * @param fuentesCeldas
	 * @param nombre
	 ...
	 *         de la tipograf�a recibidos como par�metro.
	 */
	...
	/**
	 * Clase que mantiene la relaci�n entre los atributos de una tipograf�a y
	 * una objeto HSSFFont.
	 */
