...
import ar.pegasus.framework.gui.enumerados.EnumRutaImagenesBasicas;
...
public class BossEstilos {
    ...
    public  static JButton createButton(EnumRutaImagenesBasicas enabledIcon, EnumRutaImagenesBasicas disabledIcon) {
        return DecorateUtil.createButton(enabledIcon.getRuta(), disabledIcon.getRuta());
    }
