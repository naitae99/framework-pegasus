...
import ar.pegasus.framework.entidades.enumeradores.EnumEstadoMail;
import ar.pegasus.framework.entidades.enumeradores.EnumTipoContenidoMail;
...
public class Mail implements Serializable{
	...
	private Integer idTipoMailGDT;
    private String unicoDestinatario;
    ...
    /**
     * Devuelve la <b>aplicaci�n</b> asociada.
     * @return aplicacion
     */
    ...
    /**
     * Setea la <b>aplicaci�n</b> asociada.
     * @param aplicacion
     */
    ...
    /**
     * Devuelve la direcci�n <b>origen</b> del Mail. (ie, el header from)
     * @return origen
     */
    ...
    /**
     * Devuelve la direcci�n <b>origen</b> del Mail.
     * @return rv
     * @throws Exception 
    ...
    public InternetAddress getOrigenAsInternetAddress() throws Exception {
    	if (origen == null) {
    		throw new Exception("Direcci�n origen es NULL") ;
    	}
        try {
			return new InternetAddress(origen);
		} catch (AddressException e) {
			throw new Exception("Direcci�n incorrecta (" + origen + ")", e) ;
		}
    }

    /**
     * Setea la direcci�n de <b>origen</b> del Mail.
     * @param origen
     */
    ...
    /**
     * Devuelve la <b>direcci�n de respuesta</b> del Mail.
     ...
     * @return rv
     * TODO: Modificar para aceptar varias direcciones de respuesta
     */
    ...
    /**
     * Setea la <b>direcci�n de respuesta</b> del Mail.
    ...
    /**
     * Devuelve la <b>fecha de env�o</b> del Mail.
     * @return fechaEnvio
     */
    ...
    /**
     * Setea la <b>fecha de env�o</b> del Mail.
     * @param fechaEnvio
     */
     ...
     * (ar.pegasus.framework.entidades.enumeradores.EnumEstadoMail)
     * @return estado
     */
	...
	/*
    private InternetAddress[] convertDestinatarios2Address(List<Destinatario> destinatarios) {
		InternetAddress[] rv = null;
        if(destinatarios != null) {
            rv = new InternetAddress[destinatarios.size()];
            int i = 0;
            for(Destinatario destinatario : destinatarios) {
                try {
                    rv[i] = new InternetAddress(destinatario.getDireccionMail());
                    i++;
                } catch(Throwable e) {
                    e.printStackTrace();
                }
	...
	*/
        ...
        if(destinatarios != null) {
            for(Destinatario destinatario : destinatarios) {
				try {
					...
					throw new Exception ("Direcci�n incorrecta (" + destinatario.getDireccionMail() + ")", e) ;
				}
            }
        }
	...
	/**
	 * Lo mismo que  convertDestinatarios2Address, pero cuando una direccion no es valida no tira una excepcion
	 * @param destinatarios
	 * @return
	 */
	...
	/**
	 * <p>Arma el cuerpo del mensaje de acuerdo a varias configuraciones internas.</p>
	 * <p>Por defecto solo har�a:</p> 
	 * <code>message.setText(this.getCuerpo())</code>
	 * <p>Pero har�a otras cosas en mensajes con MIME "text/html", "mime/alternative", 
	 * eventualmente imgs embebidas (sin implementar)</p> 
	 * @param newMail: javax.mail.Message
	...
	@Transient//mapeado solo en GDT
	public Integer getIdTipoMailGDT() {
		return idTipoMailGDT;
	}

	
	public void setIdTipoMailGDT(Integer idTipoMailGDT) {
		this.idTipoMailGDT = idTipoMailGDT;
	}

	@Transient//mapeado solo en GDT
	public String getUnicoDestinatario() {
		return unicoDestinatario;
	}

	
	public void setUnicoDestinatario(String unicoDestinatario) {
		this.unicoDestinatario = unicoDestinatario;
	}

	/*
	@Transient
	public EnumMailDecoder getDecoderCuerpoMail() {
		return EnumMailDecoder.getById(this.idEnumMailDecoder);
	}

	
	public void setDecoderCuerpoMail(EnumMailDecoder decoderCuerpoMail) {
		this.idEnumMailDecoder = decoderCuerpoMail.getId();
	}
	*/
